...
// Get script inputs
let thisScript = document.getElementById('circuitly-loader');
let blocklyDiv = thisScript.getAttribute('blockly_div');
let workspaceId = thisScript.getAttribute('workspace_id');
let toolboxId = thisScript.getAttribute('toolbox_id');
